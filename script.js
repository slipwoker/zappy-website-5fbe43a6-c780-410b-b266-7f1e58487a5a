document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Default success behavior (replace with actual fetch if needed)
      const action = contactForm.action;
      const method = (contactForm.method || 'POST').toUpperCase();

      if (action && action !== window.location.href && !action.endsWith('#')) {
        fetch(action, {
          method: method,
          body: formData
        })
        ...
        // No action defined — simulate success for static sites
        setTimeout(handleFormSuccess, 600);
      }
      ...
      function handleFormSuccess() {
        ...
        const successMsg = contactForm.querySelector('.form__success-message, [data-success-message]');
        if (successMsg) {
      ...
      function handleFormError(btn) {
        ...
        let errorBanner = contactForm.querySelector('.form__submit-error');
        if (!errorBanner) {
          errorBanner = document.createElement('p');
          errorBanner.className = 'form__submit-error';
          errorBanner.setAttribute('role', 'alert');
          contactForm.appendChild(errorBanner);
        }
        errorBanner.textContent = contactForm.dataset.errorSubmit ||
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שומר הבית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5fbe43a6-c780-410b-b266-7f1e58487a5a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5fbe43a6-c780-410b-b266-7f1e58487a5a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5fbe43a6-c780-410b-b266-7f1e58487a5a';
